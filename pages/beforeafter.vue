      ...
      <div class="container">
        ...
        <div class="gallery-pictures">
          ...
          <div class="gallery-pictures__item video">
            ...
            <img src="@/static/video6.png" alt="before" />
          </div>
          ...
          <div class="gallery-pictures__item video">
            ...
            <img src="@/static/video13.png" alt="before" />
          </div>
          <div
            class="gallery-pictures__item img-wrapper"
            @click="openSlide(14)"
          ...
          <div class="gallery-pictures__item video">
            ...
            <img src="@/static/video16.png" alt="before" />
          </div>
          <div class="gallery-pictures__item video">
            <div class="play-btn" @click="openSlide(17)">
              <fa :icon="['fa', 'play']" />
            </div>
            <img src="@/static/video17.png" alt="before" />
          </div>
          <div
            class="gallery-pictures__item img-wrapper"
            @click="openSlide(18)"
          >
            <img src="@/static/gallery_img18.png" alt="before" />
          </div>
          ...
          <div
            ...
            @click="openSlide(19)"
          >
            <img src="@/static/gallery_img19.png" alt="before" />
          </div>
          <div
            class="gallery-pictures__item img-wrapper"
            @click="openSlide(20)"
          >
            <img src="@/static/gallery_img20.png" alt="before" />
          </div>
          <div
            class="gallery-pictures__item img-wrapper"
            @click="openSlide(21)"
          >
            <img src="@/static/gallery_img21.png" alt="before" />
          </div>
          <div
            class="gallery-pictures__item mobile img-wrapper"
            @click="openSlide(22)"
          >
            <img src="@/static/gallery_img22.png" alt="before" />
          </div>
        </div>
      </div>
    </div>
